...
export default function App() {
  ...
  return (
    <div className="relative  bg-gradient-to-br from-red-600 via-red-700 to-red-900 flex items-center justify-center  text-white overflow-hidden min-h-screen font-sans">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-center px-5">
        <header className="">
          ...
          <div className="z-10 text-center px-6 max-w-6xl">
            ...
            <div className="py-10">
              ...
              <p className="text-xl md:text-2xl opacity-90 font-light">
                Événements professionnels & académiques à Madagascar
              </p>
            </div>
          </div>
        ...
        <article className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-3 animate-on-scroll opacity-0 translate-y-10 border-t-8 border-red-600">
          ...
          <div className="p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              l'événement réunit entreprises, institutions et talents qualifiés.
            </p>
          </div>
        </article>
