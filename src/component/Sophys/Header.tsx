...
export default function Header() {
  ...
  return (
    <div
      className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20 transform transition-all duration-2000 ${
    ...
    >
      ...
      <h2 className="text-3xl md:text-3xl font-light mb-8 bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent">
        NETTOYAGE PREMIUM RÉVOLUTIONNAIRE
      </h2>

      <p className="text-xl md:text-xl mb-12 max-w-4xl mx-auto leading-relaxed text-gray-300">
