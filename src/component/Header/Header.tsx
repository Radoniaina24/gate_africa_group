    ...
    <div className="relative min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 shadow-xl backdrop-blur-md bg-white/95 border-b border-red-100">
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center gap-5 h-18">
            {/* Logo */}
            ...
            <div className="hidden md:block text-center py-4 md:text-md lg:text-lg">
              <div
                className=" font-extrabold bg-gradient-to-r from-red-600 via-red-400 to-red-600 bg-clip-text text-transparent drop-shadow-sm"
