  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.div
            className="p-4 bg-green-100 rounded-full shadow-md"
          ...
          <motion.h1
            className="text-4xl font-extrabold text-green-700 tracking-wide"
        ...
        {/* Description */}
        <motion.p
          className="mt-2 text-gray-600 text-sm md:text-base max-w-3xl mx-auto"
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
