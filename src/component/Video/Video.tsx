  ...
  return (
    <section>
      <div className="relative w-full overflow-hidden leading-[0] -mb-1">
        <svg
          className="block w-full h-3 md:h-32 rotate-180"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-10 bg-gray-800 bg-opacity-70 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-gray-700">
              ...
              <p className="text-gray-300">
                ...
                projet novateur qui place Madagascar au cœur de
                l&apos;innovation numérique, de l&apos;éducation technologique
                et de l&apos;entrepreneuriat en Afrique et dans l&apos;Océan
                Indien. Bien plus qu&apos;un complexe universitaire, il combine
                un centre de formation d&apos;excellence, un incubateur de
                startups, et un hub technologique, attirant talents africains et
                investisseurs internationaux pour transformer l&apos;avenir de
                la région.
              </p>
            </div>
          </div>
